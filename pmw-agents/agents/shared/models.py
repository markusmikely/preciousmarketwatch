"""
PMW Shared Models — V1 minimal schema
Postgres = Source of Truth. Jobs persisted in DB; Redis = signal bus.
"""
...
class WorkflowRun(Base):
    ...
    topic = relationship("Topic", backref="runs")
...
class WorkflowStage(Base):
    ...
    run = relationship("WorkflowRun", backref="stages")
