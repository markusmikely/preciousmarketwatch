...
class LLMService:
    ...
    async def generate(
        ...
        **kwargs
        ...
        """
        Generate text with Tenacity retry for transient failures.
        """
        ...
        try:
            ...
            # Transform to our exception types
    ...
    def _calculate_cost(
        ...
        """Calculate code based on model pricing."""
        # Get pricing from config or database
        pricing = self._get_model_pricing(provider, model)

        return (input_tokens / 1000 * pricing.input_rate) + \
            (output_tokens / 1000 * pricing.output_rate)
